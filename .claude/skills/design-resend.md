---
name: design-resend
description: When the user wants to build a UI or page that looks like Resend. Use this design system for colors, typography, spacing, shadows, and component patterns inspired by Resend.
---
