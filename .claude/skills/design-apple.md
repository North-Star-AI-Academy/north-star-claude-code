---
name: design-apple
description: When the user wants to build a UI or page that looks like Apple. Use this design system for colors, typography, spacing, shadows, and component patterns inspired by Apple.
---
