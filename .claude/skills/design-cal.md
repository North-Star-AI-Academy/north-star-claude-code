---
name: design-cal
description: When the user wants to build a UI or page that looks like Cal.com. Use this design system for colors, typography, spacing, shadows, and component patterns inspired by Cal.com.
---
