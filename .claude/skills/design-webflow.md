---
name: design-webflow
description: When the user wants to build a UI or page that looks like Webflow. Use this design system for colors, typography, spacing, shadows, and component patterns inspired by Webflow.
---
